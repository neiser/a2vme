...
volatile unsigned long *MypoiVUPROMRAMData, *MypoiVUPROMRAMWriteMode;
	...
	int argc; char *argv[];
{
	...
	MypoiVUPROMRAMWriteMode = VMEWriteOpen(BaseAddr+0x2200+TopUpToMatchTriggerLevel,0); //Write Mode
...
//		MyTempPatternVUPROMAdd = *MypoiVUPROMRAMAdd;  //Erst mal die Adresse auf dem VMEbus setzen durch Lesen, um einen Fehler im VUPROM module auszugleichen
		*MypoiVUPROMRAMAdd = i;
		...
		//VMEWrite(BaseAddr+0x2220+TopUpToMatchTriggerLevel,x); //Data Address
//		MyTempPatternVUPROMData = *MypoiVUPROMRAMData;  //Erst mal die Adresse auf dem VMEbus setzen durch Lesen, um einen Fehler im VUPROM module auszugleichen
		*MypoiVUPROMRAMData = x;
		*MypoiVUPROMRAMWriteMode = 1;
		*MypoiVUPROMRAMWriteMode = 0;
